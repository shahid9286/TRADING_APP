...
<head>
    ...
    @includeif('branchManager.partials.styles')
</head>
...
<body @php
    ...
    <div class="wrapper">
        @include('branchManager.partials.top-navbar')
        @include('branchManager.partials.side-navbar')
        <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            @yield('content')
        </div>
        <!-- /.content-wrapper -->
        @include('branchManager.partials.footer')
    </div>
    <!-- ./wrapper -->
    @includeif('branchManager.partials.scripts')
