                            ...
                            <form action="{{ route('admin.admin_banks.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="Enter Bank Name" value="{{ old('name') }}" required>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="account_no" id="account_no" class="form-control"
                                        value="{{ old('account_no') }}" placeholder="Enter Account No" required>
                                    @error('account_no')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="order_no" id="order_no" class="form-control"
                                        value="{{ old('order_no') }}" min="0" placeholder="Enter Order No" required>
                                    @error('order_no')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="notes" id="notes" placeholder="Enter Notes" class="form-control">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>

                                <button type="submit" class="btn btn-primary">{{ __('Add Admin Bank') }}</button>
                            </form>
                        </div>
