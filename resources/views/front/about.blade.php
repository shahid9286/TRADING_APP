            ...
            <div class="feature__content" data-aos="fade-right" data-aos-duration="800">
              <div class="feature__content-inner">
                <div class="section-header">
                  ...
                  <p class="mb-0">
        <h6>Our mission is to empower individuals worldwide to trade smarter and earn more through our innovative trading
        platform combined with affiliate marketing </h6>
    </p>
                </div>
