$(function ($) {
    ...
    $(document).on(
        "change",
        "#product-bulk-delete input.bulk-item",
        function () {
    ...
    $(document).on(
        "change",
        "#product-category-bulk-delete input.bulk-item",
        function () {
    ...
    $(document).on(
        "change",
        "#gallery-bulk-delete input.bulk-item",
        function () {
    ...
    $(document).on(
        "change",
        "#gcategory-bulk-delete input.bulk-item",
        function () {
    ...
    $(document).on(
        "change",
        "#jcategory-bulk-delete input.bulk-item",
        function () {
    ...
    $(document).on(
        "change",
        "#applicant-bulk-delete input.bulk-item",
        function () {
    ...
    $(document).on(
        "change",
        "#bcategory-bulk-delete input.bulk-item",
        function () {
    ...
    $(document).on(
        "change",
        "#newsletter-bulk-delete input.bulk-item",
        function () {
